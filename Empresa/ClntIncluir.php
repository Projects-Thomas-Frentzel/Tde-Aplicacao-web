...
<div class="w3-main w3-container" style="margin-left:270px;margin-top:117px;">
    ...
    <div class="w3-panel w3-padding-large w3-card-4 w3-light-grey">
        <!-- h1 class="w3-xxlarge">Contratação de Funcionario</h1 -->
        <p class="w3-large">
            <div class="w3-code cssHigh notranslate">
                ...
                <div class="w3-responsive w3-card-4">
                    ...
                    <form class="w3-container" action="funIncluir_exe.php" method="post" enctype="multipart/form-data">
					...
					<tr>
						...
						<label class="w3-text-IE"><b>Nome</b></label>
							...
							<input class="w3-input w3-border w3-light-grey " name="CPF" id="CPF"  type="text" maxlength="15"
						       placeholder="CPF XXX.XXX.XXX-XX" title="CPF XXX.XXX.XXX-XX" value="<?php echo $CRM; ?>" pattern="CPF\/([A-Z]{2}) [0-11]{4}-[0-11]{2}$" required></p>
						<p>
