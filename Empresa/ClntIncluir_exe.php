  ...
  <!-- Acesso em:-->
	...
	<?php
		...
		if ($_FILES['Imagem']['size'] == 0) { // Não recebeu uma imagem binária
			$sql = "INSERT INTO Funcionario (Nome, CPF, Data_nasc, ID_Pais, Foto) VALUES ('$nome','$CPF','$dtNasc ', '$nascio', NULL)";
		} else {                              // Recebeu uma imagem binária
			$imagem = addslashes(file_get_contents($_FILES['Imagem']['tmp_name'])); // Prepara para salvar em BD
			$sql = "INSERT INTO Funcionario (Nome, CPF, Data_nasc, ID_Pais, Foto) VALUES ('$nome','$CPF','$dtNasc ', '$nascio','$imagem')";
		}
		?>
