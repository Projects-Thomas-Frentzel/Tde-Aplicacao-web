	...
	<div class="w3-main w3-container" style="margin-left:270px;margin-top:117px;">
		<div class="w3-panel w3-padding-large w3-card-4 w3-light-grey">
			...
			<div class="w3-code cssHigh notranslate">
				...
				$sql = "SELECT ID_Cliente, Nome, CPF, Data_nasc, ID_Pais FROM Cliente WHERE ID_Cliente = $id";
				...
				if ($result = mysqli_query($conn, $sql)) {
					if(mysqli_num_rows($result) == 1){
						...
						<div class="w3-container w3-theme">
							<h2>Altere os dados do Codigo do Cliente. = [<?php echo $id_fun; ?>]</h2>
						</div>
						<form class="w3-container" action="funAtualizar_exe.php" method="post" enctype="multipart/form-data">
						<table class='w3-table-all'>
						<tr>
							<td style="width:50%;">
							<p>
							<input type="hidden" id="Id" name="Id" value="<?php echo $id_fun; ?>">
							<p>
							...
							<input class="w3-input w3-border w3-light-grey " name="CPF" id="CPF"  type="text" maxlength="15"
						       placeholder=" XXX.XXX.XXX-XX" title=" XXX.XXX.XXX-XX" value="<?php echo $CPF; ?>" pattern="CPF [0-11]{4}-[0-11]{2}$" required></p>
							<p>
