    ...
    <div class="w3-panel w3-padding-large w3-card-4 w3-light-grey">
        <p class="w3-large">
            <div class="w3-code cssHigh notranslate">
				...
				$sqlG = "SELECT nome_pais,ID_pais FROM Pais";
                ...
                <div class="w3-responsive w3-card-4">
                    ...
                    <form class="w3-container" action="empIncluir_exe.php" method="post" enctype="multipart/form-data">
					...
					<tr>
						...
						<td>
						<p style="text-align:center"><label class="w3-text-IE"><b>Imagem para a Identificação: </b></label></p>
