    ...
    <div class="w3-panel w3-padding-large w3-card-4 w3-light-grey">
        <p class="w3-large">
            <div class="w3-code cssHigh notranslate">
				...
				$sql = "SELECT ID_Cliente, CPF, Nome, Nacionalidade FROM Cliente WHERE ID_Cliente = $id";
				//Inicio DIV form
			...
			?>
						<div class="w3-container w3-theme">
							<h2>Exclusão do Funcionario Cód. = [<?php echo $row['ID_Fun']; ?>]</h2>
						</div>
						<form class="w3-container" action="ClntExcluir_exe.php" method="post" onsubmit="return check(this.form)">
							<input type="hidden" id="Id" name="Id" value="<?php echo $row['ID_Fun']; ?>">
							<p>
							...
							<input type="button" value="Cancelar" class="w3-btn w3-theme" onclick="window.location.href='funListar.php'"></p>
						</form>
			<?php 
					}else{?>
						<div class="w3-container w3-theme">
